...
def serializedATN():
    return [
        ...
        0,2,4,6,8,10,12,14,16,0,1,2,0,20,58,61,61,57,0,18,1,0,0,0,2,23,1,
        ...
        5,2,0,0,46,55,3,16,8,0,47,55,5,11,0,0,48,55,5,12,0,0,49,55,5,61,
...
class rangesParser ( Parser ):
    ...
    def symbol(self):
        ...
        try:
            ...
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & 2882303761516068864) != 0)):
