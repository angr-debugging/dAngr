...
from dAngr.MCP.breakpoints import BreakpointMCPCommands
from dAngr.MCP.execution import ExecutionMCPCommand
...
from dAngr.MCP.tools import dAngr_tools
import inspect
...
class dAngrMCP():
    ...
    def run(self):
        self.mcp.settings.log_level = 'CRITICAL'
